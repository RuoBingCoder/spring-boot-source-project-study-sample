package com.github.simple.core.constant;

/**
 * @author: JianLei
 * @date: 2020/12/11 10:47 下午
 * @description: SimpleIocConstant
 */
...
public class SimpleIOCConstant {
    ...
    public static final String DEFAULT_SOURCE_NAME = "application";
