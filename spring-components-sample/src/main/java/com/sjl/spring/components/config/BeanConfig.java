...
import com.sjl.spring.components.pojo.ConfigBeanB;
...
public class BeanConfig {
     ...
     *
     * method.invoke() 拦截器 {@link org.springframework.context.annotation.ConfigurationClassEnhancer.BeanMethodInterceptor#intercept(Object, Method, Object[], MethodProxy)} 会对方法调用顺序进行判断 保证已经创建过的bean 不会再次被创建
     ...
     * 
     * 
     * @see com.sjl.spring.components.cglib.test.Test 演示了原理
     */
    @Bean
