package com.github.spring.components.learning.enhancemybatis.registry;
...
//        DefaultSqlInjector sqlInjector = (DefaultSqlInjector) GlobalConfigUtils.getSqlInjector(configuration);
    ...
    private void doAddCommonMappedStatement() {
        ...
        try {
          ...
          /* SqlSessionFactory sqlSessionFactory=new DefaultSqlSessionFactory(configuration); //主要验证不同的sqlSession 一级缓存是不共享的,容易出现脏读
