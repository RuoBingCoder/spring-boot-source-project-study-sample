package com.github.spring.components.learning.mybatis.registry;
...
import com.github.spring.components.learning.mybatis.common.constant.SqlMethodEnums;
...
import com.github.spring.components.learning.mybatis.common.wrapper.MapperMethodWrapper;
...
import utils.CommonReflectUtil;
...
//        DefaultSqlInjector sqlInjector = (DefaultSqlInjector) GlobalConfigUtils.getSqlInjector(configuration);
    ...
    private void doAddCommonMappedStatement() {
        ...
        String daoScan = ClassUtils.getMapperScanAnnotationValue(SpringComponentsLearningApplication.class, MapperScan.class);
